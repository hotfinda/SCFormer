...
import models.dilatenet as dilatenet
import models.alternetNew as newnet
import models.dilatenetNew as dilatenetNew
import models.daa as daanet
...
def get_model(name, num_classes=10, stem=False, verbose=True, **block_kwargs):
    ...
    #AlterNet
    elif name in ["alternet","alternet_50"]:
        model = alternet.dnn_50(num_classes=num_classes, stem=stem, name=name, **block_kwargs)
        
    #dilatenet-after-attention
    elif name in ["daa_50"]:
        model = daanet.dnn_50(num_classes=num_classes, stem=stem, name=name, **block_kwargs)
        
    #dilatenet
    elif name in ["dilatenet","dilatenet_50"]:
        model = dilatenet.dnn_50(num_classes=num_classes, stem=stem, name=name, **block_kwargs)
        
    #new ditalenet
    elif name in ["newnet_50"]:
        model = newnet.dnn_50(num_classes=num_classes, stem=stem, name=name, **block_kwargs)
        
    elif name in ["mixnet_50"]:
        model = dilatenetNew.dnn_50(num_classes=num_classes, stem=stem, name=name, **block_kwargs)
